...
class ReportInvoiceMultiple(models.AbstractModel):
    _name = 'report.ams_accounting_kit.report_multiple_invoice'
    ...
    def _get_report_values(self, docids, data=None):
        ...
        if layout == 'web.external_layout_boxed':
            new_layout = 'ams_accounting_kit.boxed'

        elif layout == 'web.external_layout_bold':
            new_layout = 'ams_accounting_kit.bold'

        elif layout == 'web.external_layout_striped':
            new_layout = 'ams_accounting_kit.striped'

        else:
            new_layout = 'ams_accounting_kit.standard'
