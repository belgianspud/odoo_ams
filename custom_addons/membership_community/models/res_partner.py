...
class ResPartner(models.Model):
    ...
    # Core Member Fields (from AMS Foundation)
    ...
    # Membership Records (from Membership Community)
    ...
    # Current Membership (computed from membership records)
    ...
    membership_state = fields.Selection(
        related='current_membership_id.state', 
        string='Membership Status',
        store=True
    )
    membership_type = fields.Char(
        related='current_membership_id.membership_type_id.name', 
